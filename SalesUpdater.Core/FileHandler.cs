...
namespace SalesUpdater.Core
{
    public class FileHandler : IFileHandler
    {
        ...
        private void WriteToDatabase(IEnumerable<IFile> sales, string managerSurame)
        {
            Unit.Add(CreateDataObjects(sales, managerSurame).ToArray());
        }
        ...
        string managerLastName)
        {
            try
            {
                ...
                return (from fileContent in fileContents
                        ...
                        let customerName = Parser.ParseLine(fileContent.Client, clientNameSplitter)
            ...
            {
                throw new FormatException("Customer field must contain Name and Surame");
            }
        }
    }
}
